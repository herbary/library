...
#define _DEFN_COMPARE_NO_GENERIC_FUNC_TYPE(prefix, type) \
...
#define _DEFN_COMPARE_GENERIC_FUNC_TYPE(prefix) \
...
#define _DEFN_COMPARE_FUNC_TYPE(prefix, type) \
	_DEFN_COMPARE_NO_GENERIC_FUNC_TYPE(prefix, type) \
	_DEFN_COMPARE_GENERIC_FUNC_TYPE(prefix)
