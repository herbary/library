...
#define _DEFN_IS_SORTED_FUNC(prefix, type) \
...
#define _DEFN_IS_SORTED_NO_SIZE_PARAM_FUNC(prefix, type) \
...
#define _DEFN_SORT_FUNC(prefix, name, type) \
...
#define _DEFN_SORT_NO_SIZE_PARAM_FUNC(prefix, name, type) \
...
#define _DECL_IS_SORTED_NO_SIZE_PARAM_FUNC(prefix, type) \
...
#define _DECL_SORT_NO_SIZE_PARAM_FUNC(prefix, name, type) \
