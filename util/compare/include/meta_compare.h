...
#define _DEFN_COMPARE_NO_GENERIC_FUNC(prefix, type) \
...
#define _DEFN_COMPARE_GENERIC_FUNC(prefix) \
...
#define _DEFN_COMPARE_FUNC(prefix, type) \
	_DEFN_COMPARE_NO_GENERIC_FUNC(prefix, type) \
	_DEFN_COMPARE_GENERIC_FUNC(prefix)

#define _DECL_COMPARE_NO_GENERIC_FUNC(prefix, type) \
	int8_t prefix##_compare(const type n0, const type n1, const sort_order_t order) { \
...
#define _DECL_COMPARE_GENERIC_FUNC(prefix, type) \
	int8_t generic_##prefix##_compare(const void *const n0, const void *const n1, const sort_order_t order) { \
...
#define _DECL_COMPARE_FUNC(prefix, type) \
	_DECL_COMPARE_NO_GENERIC_FUNC(prefix, type) \
	_DECL_COMPARE_GENERIC_FUNC(prefix, type)
