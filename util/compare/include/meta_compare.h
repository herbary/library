...
#define _HERBARY_LIB_UTIL_DEFN_COMPARE_GENERIC_FUNC(prefix) \
...
#define _HERBARY_LIB_UTIL_DEFN_COMPARE_FUNC(prefix, type) \
	...
	_HERBARY_LIB_UTIL_DEFN_COMPARE_GENERIC_FUNC(prefix)
...
#define _HERBARY_LIB_UTIL_DECL_COMPARE_GENERIC_FUNC(prefix, type) \
	int8_t generic_##prefix##_compare(const void *const n0, const void *const n1, const sort_order_t order) { \
...
#define _HERBARY_LIB_UTIL_DECL_COMPARE_FUNC(prefix, type) \
	...
	_HERBARY_LIB_UTIL_DECL_COMPARE_GENERIC_FUNC(prefix, type)
